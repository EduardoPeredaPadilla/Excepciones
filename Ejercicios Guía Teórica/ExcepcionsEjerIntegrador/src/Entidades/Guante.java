...
public class Guante implements Usar, Reparar, Arreglar {
    ...
    public Guante(String lado, Estado estado, int consumoE) {
        this.lado = lado;
        this.estado = estado;
    ...
    public int volar(Armadura arm, int tiempo) throws EnergiaInsuficienteException, DamageDeviceException, DestroyedDeviceException {
        ...
        if (eConsumida > arm.getReactor()) {
            ...
            System.out.println("Energía consumida guante " + lado + " = " + eConsumida);
            ...
            if (probDamage <= 3) {
                ...
                System.out.println("  - Dispositivo guante " + lado + " dañado");
            }
            return eConsumida;
        }
    }

    public int disparar(Armadura arm, int tiempo) throws EnergiaInsuficienteException, DamageDeviceException, DestroyedDeviceException {
    ...
    public boolean repararDispositivo(int prob) {
        ...
        int probDamage = random.nextInt(10) + 1;
        if (probDamage <= prob) {
            System.out.println("Dispositivo guante " + lado + " reparado");
            return true;
        } else {
            System.out.println("El Dispositivo guante " + lado + " no se pudo reparar");
            return false;
        }
    }
    ...
    public boolean arreglarDispositivo(int prob) throws DestroyedDeviceException {
        ...
        if (probDestruido <= prob) {
            ...
            System.out.println("El Dispositivo guante " + lado + " no se pudo reparar y quedó destruido");
            return false;
        } else {
